...
#remove packages
alias yayr="yay -Qqe | fzf --multi --preview 'yay -Qi {1}' --preview-window=down:75% | xargs -ro yay -Rns --noconfirm --cleanafter"
...
alias upd='sudo pacman -Syu --noconfirm && yay -Syu --noconfirm && sudo flatpak update -y'
alias tx='micro'
alias nano='micro'
alias ff='fastfetch'
...
alias lsh='lsd -a --group-dirs=first'

# Make executable
alias mx='chmod +x'

# Ghost Track app
alias ghostr='python3 /home/benja/apps/GhostTR/GhostTR.py'
